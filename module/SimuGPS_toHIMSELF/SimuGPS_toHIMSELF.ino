...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    testMethod(GetLongitudeANDGetLatitude, "GetLongitude&GetLatitude");
  }


}

void testMethod(void (*method)(), const char* methodName) {
  Serial.print("Testing method: ");
...
void GetLongitudeANDGetLatitude() {
